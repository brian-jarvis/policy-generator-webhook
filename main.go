...
func main() {
  ...
  mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
    ...
    LeaderElectionID:           "7256067a.bry.redhat.io",
  })
  if err != nil {
  ...
  webhookSvr.Register("/mutate", &webhook.Admission{Handler: &handler.PolicyGeneratorMutator{Client: mgr.GetClient(), Log: ctrl.Log.WithName("PolicyGenerator")}})
